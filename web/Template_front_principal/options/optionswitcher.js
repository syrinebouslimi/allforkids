$('.body-wrapper').each(function(){var link=$(`<!--=== option Switcher ===-->
	  ...
	  <!--/option-switcher-->`);$('.body-wrapper').prepend(link);});var panel=jQuery('.option-switcher');jQuery('.option-switcher-btn').click(function(){jQuery(this).hide(100);jQuery('.option-switcher').addClass('fadeInRight').removeClass('fadeOutRight').show();});jQuery('.theme-close').click(function(){jQuery('.option-switcher').removeClass('fadeInRight').addClass('fadeOutRight').hide(1000);jQuery('.option-switcher-btn').show(1000);});jQuery('.color-options li').click(function(){var color=jQuery(this).attr("data-color");setColor(color);jQuery('.color-options li').removeClass("theme-active");jQuery(this).addClass("theme-active");});var setColor=function(color){jQuery('#option_color').attr("href","css/"+color+".css");}
